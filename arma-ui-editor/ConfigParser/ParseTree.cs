...
namespace TinyPG
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                ...
                case TokenType.fControls:
                    Value = EvalfControls(tree, paramlist);
                    break;
                case TokenType.bControls:
                    Value = EvalbControls(tree, paramlist);
                    break;
                case TokenType.Control:
                    Value = EvalControl(tree, paramlist);
                    break;
        ...
        protected virtual object EvalfControls(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalbControls(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalControl(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }
